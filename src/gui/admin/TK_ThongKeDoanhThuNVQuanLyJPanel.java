...
public class TK_ThongKeDoanhThuNVQuanLyJPanel extends JPanel implements ActionListener {
	...
	private JTable tblNhanVienThongKeDoanhThuNam;
	...
	public TK_ThongKeDoanhThuNVQuanLyJPanel() {
		...
		txtNhanXetThongKeNgay.setText(
				"Tài khoản A còn 23 ngà để đạt doanh thu bằng với tháng trước đó là 999.999.999 VND. Tài khoản A còn 23 ngà để đạt doanh thu bằng với tháng trước đó là 999.999.999 VND.");
		...
		panelChuThichBieuDoThongKeDTNgay.setBorder(
		...
		panelBoLocTimKiem_1.setBorder(new TitledBorder(null, "B\u1ED9 l\u1ECDc t\u00ECm ki\u1EBFm",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		cbxChonThangThongKeDT.setModel(new DefaultComboBoxModel(
		...
		cbxChonNamCuaThangThongKeDT
				.setModel(new DefaultComboBoxModel(new String[] { "2022", "2023", "Viết hàm getYear[]" }));
		...
		panel_1_1.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"D\u1EEF li\u1EC7u th\u1ED1ng k\u00EA \u0111\u01B0\u1EE3c trong th\u00E1ng :", TitledBorder.LEADING,
		...
		panelChuThichBieuDoTKDTThang.setBorder(
				new TitledBorder(null, "Ch\u00FA th\u00EDch : ", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelBangNhanVienTKDTNam.setBorder(
				new TitledBorder(null, "Danh sách nhân viên", TitledBorder.CENTER, TitledBorder.TOP, null, null));
		...
		tblNhanVienThongKeDoanhThuNam = new JTable(modelTblNhanVienThongKeDoanhThuNam);
		panelBangNhanVienTKDTNam.add(new JScrollPane(tblNhanVienThongKeDoanhThuNam));
		// <======>
		...
		panel_1_2.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"D\u1EEF li\u1EC7u th\u1ED1ng k\u00EA \u0111\u01B0\u1EE3c trong n\u0103m :", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panelBieuDoThongKeNgay_2.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"Bi\u1EC3u \u0111\u1ED3 th\u1ED1ng k\u00EA", TitledBorder.LEADING, TitledBorder.TOP, null,
				new Color(0, 0, 0)));
		...
		panelChuThichBieuDoThongKeDTNam.setBorder(
				new TitledBorder(null, "Ch\u00FA th\u00EDch : ", TitledBorder.LEADING, TitledBorder.TOP, null, null));
